...
class A9MEM1571{
	...
	static lib_url = "../../lib/A9MEM1571.js";
...
//        this._changedCurrent_L1 = self.homey.flow.getDeviceTriggerCard('changedCurrentL1');
		...
		this.client 	= new A9MEM1571.ModbusRTU();	
		console.log("initiated duco device: " + A9MEM1571.name + "@" +this.duco_IPaddress+":"+this.duco_IPport+"->"+this.duco_modbusID);
...
exports = module.exports = A9MEM1571;