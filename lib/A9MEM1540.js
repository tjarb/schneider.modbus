...
class A9MEM1540{
    static name = "3P+N (A9MEM1540)";
	static icon= "/icon.svg"; 		// relative to: /drivers/<driver_id>/assets/
	static capabilities = ["measure_voltage.L1", "measure_voltage.L2", "measure_voltage.L3", "measure_current.L1", "measure_current.L2", "measure_current.L3", "measure_power.L1", "measure_power.L2", "measure_power.L3", "measure_pf", "operational_status.type"];
	static capabilitiesOptions= { };
	


	static lib_url = "../../lib/A9MEM1540.js";
...
//        this._changedCurrent_L1 = self.homey.flow.getDeviceTriggerCard('changedCurrentL1');
		...
		this.client 	= new A9MEM1540.ModbusRTU();	
		console.log("initiated duco device: " + A9MEM1540.name + "@" +this.duco_IPaddress+":"+this.duco_IPport+"->"+this.duco_modbusID);
    ...
    handler(self){  //self.log("####### DEVICE_LIB CODE ######");					
						...
						this.client.connectTCP(this.duco_IPaddress, { port: this.duco_IPport }).then(() =>{					
							...
							Promise.allSettled([
								...
								this.client.readHoldingRegisters(3019, 6),			//Volt	phase-phase
...
exports = module.exports = A9MEM1540;